...
outputs:
  - id: out_vcf
    ...
    format: edam:format_3016
    outputBinding: 
      glob: $(inputs.vcf.basename).SNP.g.vcf.gz
  - id: out_vcf_tbi
    type: File
    outputBinding:
      glob: $(inputs.vcf.basename).SNP.g.vcf.gz.tbi
  - id: log
    type: stderr

stderr: $(inputs.vcf.basename).SNP.g.vcf.gz.log
...
arguments:
  ...
  - position: 35
    prefix: -o
    valueFrom: $(inputs.vcf.basename).SNP.g.vcf.gz
  - position: 36
    valueFrom: "&&"
  - position: 37
    valueFrom: "rm"
