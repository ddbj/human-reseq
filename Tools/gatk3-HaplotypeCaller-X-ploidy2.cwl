...
outputs:
  - id: vcf
    ...
    outputBinding: 
      glob: $(inputs.outprefix).chrX.g.vcf.gz
  - id: vcf_tbi
    type: File
    outputBinding:
      glob: $(inputs.outprefix).chrX.g.vcf.gz.tbi
  - id: log
    type: stderr

stderr: $(inputs.outprefix).chrX.g.vcf.gz.log
...
arguments:
  ...
  - position: 34
    prefix: -L
    valueFrom: "X:60001-155270560"
  - position: 35
    prefix: -ploidy
    valueFrom: "2"
  - position: 36
    prefix: -o
    valueFrom: $(inputs.outprefix).chrX.g.vcf.gz
  - position: 37
