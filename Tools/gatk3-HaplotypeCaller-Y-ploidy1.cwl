...
outputs:
  - id: vcf
    ...
    outputBinding: 
      glob: $(inputs.outprefix).chrY.g.vcf.gz
  - id: vcf_tbi
    type: File
    outputBinding:
      glob: $(inputs.outprefix).chrY.g.vcf.gz.tbi
  - id: log
    type: stderr

stderr: $(inputs.outprefix).chrY.g.vcf.gz.log
...
arguments:
  ...
  - position: 36
    prefix: -o
    valueFrom: $(inputs.outprefix).chrY.g.vcf.gz
  - position: 37
