...
outputs:
  - id: vcf
    ...
    outputBinding: 
      glob: $(inputs.outprefix).chrX_core2.g.vcf.gz
  - id: vcf_tbi
    type: File
    outputBinding:
      glob: $(inputs.outprefix).chrX_core2.g.vcf.gz.tbi
  - id: log
    type: stderr

stderr: $(inputs.outprefix).chrX_core2.g.vcf.gz.log
...
arguments:
  ...
  - position: 34
    prefix: -L
    valueFrom: "X:92375510-154931043"
  - position: 35
    prefix: -ploidy
    valueFrom: "1"
  - position: 36
    prefix: -o
    valueFrom: $(inputs.outprefix).chrX_core2.g.vcf.gz
  - position: 37
