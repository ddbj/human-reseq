...
steps:
  bams2gvcfwoBQSR_female:
    run: bams2gvcf.woBQSR_female.cwl
    in:
      reference: reference
...
outputs:
  rmdup_bam:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/rmdup_bam
    secondaryFiles:
      - ^.bai

  rmdup_metrics:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/rmdup_metrics

  rmdup_log:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/rmdup_log

  picard_collect_multiple_metrics_alignment_summary_metrics:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_collect_multiple_metrics_alignment_summary_metrics
    secondaryFiles:
  ...
  picard_collect_multiple_metrics_insert_size_metrics:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_collect_multiple_metrics_insert_size_metrics
    secondaryFiles:
      - ^.insert_size_histogram.pdf

  picard_collect_multiple_metrics_log:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_collect_multiple_metrics_log

  samtools_flagstat_flagstat:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/samtools_flagstat_flagstat

  samtools_idxstats_idxstats:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/samtools_idxstats_idxstats

  picard_CollectWgsMetrics_autosome_wgs_metrics:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_CollectWgsMetrics_autosome_wgs_metrics

  picard_CollectWgsMetrics_autosome_log:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_CollectWgsMetrics_autosome_log
    
  picard_CollectWgsMetrics_chrX_wgs_metrics:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_CollectWgsMetrics_chrX_wgs_metrics

  picard_CollectWgsMetrics_chrX_log:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_CollectWgsMetrics_chrX_log
    
  picard_CollectWgsMetrics_chrY_wgs_metrics:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_CollectWgsMetrics_chrY_wgs_metrics

  picard_CollectWgsMetrics_chrY_log:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/picard_CollectWgsMetrics_chrY_log
    
  gatk3_HaplotypeCaller_vcf:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/gatk3_HaplotypeCaller_vcf
    secondaryFiles:
      - .tbi

  gatk3_HaplotypeCaller_log:
    type: File[]
    outputSource: bams2gvcfwoBQSR_female/gatk3_HaplotypeCaller_log
